...
# Title: Top Block
# Generated: Mon Dec 28 08:43:01 2020
##################################################
...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.show_image_0_0 = display.show_image(
        	512,  # Picture width
        	512,  # Picture height
        )
        ...
        self.DNC_MDC_decoding_2_0 = DNC.MDC_decoding(512, 512, 2)
        self.DNC_MDC_decoding_2 = DNC.MDC_decoding(512, 512, 1)
        self.DNC2_hamming_decoder_1 = DNC2.hamming_decoder(3)
        self.DNC2_hamming_decoder_0 = DNC2.hamming_decoder(3)

        ##################################################
        # Connections
        ##################################################
        self.connect((self.DNC2_hamming_decoder_0, 0), (self.DNC_MDC_decoding_2, 0))
        self.connect((self.DNC2_hamming_decoder_0, 0), (self.DNC_MDC_decoding_2_0, 0))
        self.connect((self.DNC2_hamming_decoder_1, 0), (self.DNC_MDC_decoding_2, 1))
        self.connect((self.DNC2_hamming_decoder_1, 0), (self.DNC_MDC_decoding_2_0, 1))
        self.connect((self.DNC_MDC_decoding_2, 0), (self.show_image_0_0, 0))
        self.connect((self.DNC_MDC_decoding_2_0, 0), (self.show_image_0_0_1, 0))
        ...
        self.connect((self.DNC_packet_arrangement_0, 0), (self.DNC2_hamming_decoder_1, 0))
        self.connect((self.DNC_packet_arrangement_0_0, 0), (self.DNC2_hamming_decoder_0, 0))
