...
# Title: Top Block
# Generated: Mon Dec 28 03:44:35 2020
##################################################
...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.data_size_B = data_size_B = 1024
        ...
        # Blocks
        ##################################################
        self.show_image_1_0 = display.show_image(
        	512,  # Picture width
        	512,  # Picture height
        )
        self._show_image_1_0_win = sip.wrapinstance(self.show_image_1_0.pyqwidget(), Qt.QWidget)
        self.top_layout.addWidget(self._show_image_1_0_win)
        self.show_image_1 = display.show_image(
        	512,  # Picture width
        	512,  # Picture height
        )
        self._show_image_1_win = sip.wrapinstance(self.show_image_1.pyqwidget(), Qt.QWidget)
        self.top_layout.addWidget(self._show_image_1_win)
        ...
        self.osmosdr_source_0 = osmosdr.source( args="numchan=" + str(1) + " " + 'bladerf=3627' )
        ...
        self.osmosdr_sink_0_0 = osmosdr.sink( args="numchan=" + str(1) + " " + 'bladerf=3627' )
        ...
        self.osmosdr_sink_0.set_center_freq(2.405e9, 0)
        ...
        self.DNC_nodeB_controller_0 = DNC.nodeB_controller(127, data_size_B, 6, 10, 20, 30, 40)
        self.DNC_nodeA_controller_0 = DNC.nodeA_controller(127, data_size, 6, 10, 20, 30, 40)
        self.DNC2_image_vector_source_0_0_0 = DNC2.image_vector_source('/home/ubuntu/Desktop/SDR_NC/2 Nodes/2_P2P_Img/livingroom_gray_512.txt', 512*512, data_size_B, False, 1, 1, [])
        self.DNC2_image_vector_source_0_0 = DNC2.image_vector_source('/home/ubuntu/Desktop/SDR_NC/2 Nodes/2_P2P_Img/lena_gray_512.txt', 512*512, data_size, False, 1, 1, [])
        self.DNC2_hamming_encoder_1_0 = DNC2.hamming_encoder(3, 512*512, data_size_B)
        self.DNC2_hamming_encoder_1 = DNC2.hamming_encoder(3, 512*512, data_size)

        ##################################################
        # Connections
        ##################################################
        self.connect((self.DNC2_hamming_encoder_1, 0), (self.DNC_nodeA_controller_0, 1))
        self.connect((self.DNC2_hamming_encoder_1_0, 0), (self.DNC_nodeB_controller_0, 1))
        self.connect((self.DNC2_image_vector_source_0_0, 0), (self.DNC2_hamming_encoder_1, 0))
        self.connect((self.DNC2_image_vector_source_0_0, 0), (self.show_image_1, 0))
        self.connect((self.DNC2_image_vector_source_0_0_0, 0), (self.DNC2_hamming_encoder_1_0, 0))
        self.connect((self.DNC2_image_vector_source_0_0_0, 0), (self.show_image_1_0, 0))
        self.connect((self.DNC_nodeA_controller_0, 0), (self.s4a_byte_to_bit_0, 0))
        self.connect((self.DNC_nodeB_controller_0, 0), (self.s4a_byte_to_bit_0_0, 0))
        ...
        self.connect((self.osmosdr_source_0, 0), (self.dc_blocker_xx_0_0_0, 0))
        self.connect((self.osmosdr_source_0_0, 0), (self.dc_blocker_xx_0_0, 0))
        self.connect((self.s4a_bpsk_demapper_0, 0), (self.DNC_nodeA_controller_0, 0))
        self.connect((self.s4a_bpsk_demapper_0_0, 0), (self.DNC_nodeB_controller_0, 0))
        self.connect((self.s4a_bpsk_mapper_0, 0), (self.s4a_ofdm_modulator_0, 0))
        self.connect((self.s4a_bpsk_mapper_0_0, 0), (self.s4a_ofdm_modulator_0_0, 0))
        ...
        self.connect((self.s4a_ofdm_modulator_0_0, 0), (self.osmosdr_sink_0_0, 0))
    ...
    def get_data_size_B(self):
        return self.data_size_B

    def set_data_size_B(self, data_size_B):
        self.data_size_B = data_size_B
