...
# Generated: Thu Feb 13 14:08:21 2020
##################################################
...
class bladeRF_rx(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, buflen=4096, dc_offset_i=0, dc_offset_q=0, instance=0, num_buffers=16, num_xfers=8, rx_bandwidth=1.5e6, rx_frequency=950e6, rx_lna_gain=6, rx_sample_rate=3e6, rx_vga_gain=20, serial="", verbosity="info"):
    ...
    def set_gui_bladerf_args(self, gui_bladerf_args):
        ...
        Qt.QMetaObject.invokeMethod(self._gui_bladerf_args_label, "setText", Qt.Q_ARG("QString", self.gui_bladerf_args))
...
def argument_parser():
    ...
    parser.add_option(
        "", "--dc-offset-i", dest="dc_offset_i", type="eng_float", default=eng_notation.num_to_str(0),
        help="Set DC offset compensation for I channel [default=%default]")
    parser.add_option(
        "", "--dc-offset-q", dest="dc_offset_q", type="eng_float", default=eng_notation.num_to_str(0),
    ...
    parser.add_option(
        "-b", "--rx-bandwidth", dest="rx_bandwidth", type="eng_float", default=eng_notation.num_to_str(1.5e6),
        help="Set Bandwidth [default=%default]")
    parser.add_option(
        "-f", "--rx-frequency", dest="rx_frequency", type="eng_float", default=eng_notation.num_to_str(950e6),
        help="Set Frequency [default=%default]")
    parser.add_option(
        "-l", "--rx-lna-gain", dest="rx_lna_gain", type="intx", default=6,
        help="Set RX LNA Gain [default=%default]")
    parser.add_option(
        "-s", "--rx-sample-rate", dest="rx_sample_rate", type="eng_float", default=eng_notation.num_to_str(3e6),
    ...
    parser.add_option(
        "", "--verbosity", dest="verbosity", type="string", default="info",
