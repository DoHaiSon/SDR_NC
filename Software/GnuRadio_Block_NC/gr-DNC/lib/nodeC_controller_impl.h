...
namespace gr {
  namespace DNC {
	...
	int d_rx1_ended_packet_number_index;
	...
	bool d_packet_out;
	bool d_rcvd_xor_data;
	bool d_rcvd_nodeA_data;
	bool d_rcvd_nodeB_data;
	bool d_request_to_start_new_session;
	int d_data_out_index;
	int d_packet_out_index;

	unsigned char d_rx0_packet_number[3];
	unsigned char d_rx1_packet_number[3];
	unsigned char d_rx1_ended_packet_number[3];
	...
	int d_nodeA_no_rcvd_pkts;
	int d_nodeB_no_rcvd_pkts;
	int d_xor_no_rcvd_pkts;
     public:
