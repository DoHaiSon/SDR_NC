...
namespace gr {
  namespace DNC {
    ...
    receiver_control_p2p::make(int packet_size, unsigned char transmitter_id, unsigned char receiver_id)
    {
      return gnuradio::get_initial_sptr
        (new receiver_control_p2p_impl(packet_size, transmitter_id, receiver_id));
    }

    /*
     * The private constructor
     */
    receiver_control_p2p_impl::receiver_control_p2p_impl(int packet_size, unsigned char transmitter_id, unsigned char receiver_id)
      : gr::block("receiver_control_p2p",
              gr::io_signature::make(1, 1, sizeof(unsigned char)),
              gr::io_signature::make2(2, 2, sizeof(unsigned char), sizeof(unsigned char))),
	      d_packet_size(packet_size), d_transmitter_id(transmitter_id), d_receiver_id(receiver_id), 
