 ...
 *
 ******************************************************************************/
#ifndef INCLUDED_S4A_OFDM_POWER_SCALING_IMPL_H
#define INCLUDED_S4A_OFDM_POWER_SCALING_IMPL_H
...
class ofdm_power_scaling_impl: public ofdm_power_scaling
{
private:
	enum state_t
	{
...
public:
	ofdm_power_scaling_impl(int fft_length, float preamble_coeff,
...
#endif /* INCLUDED_S4A_OFDM_POWER_SCALING_IMPL_H */
