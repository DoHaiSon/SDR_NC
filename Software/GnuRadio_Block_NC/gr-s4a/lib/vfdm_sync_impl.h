 ...
 *
 ******************************************************************************/
#ifndef INCLUDED_S4A_VFDM_SYNC_IMPL_H
#define INCLUDED_S4A_VFDM_SYNC_IMPL_H
...
class vfdm_sync_impl: public vfdm_sync
{
private:
	/**
	 * Enum that defines finite-state machine states
	 */
	enum state_t
	{
		ST_IDLE,
	...
	double d_avg_phase_shift;
	int d_phase_shift_idx;
...
public:
	...
	vfdm_sync_impl(int fft_length, int occupied_tones, int cp_length,
...
#endif /* INCLUDED_S4A_VFDM_SYNC_IMPL_H */
