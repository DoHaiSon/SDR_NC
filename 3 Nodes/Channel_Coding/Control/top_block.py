...
# Title: Top Block
# Generated: Sat Dec 26 07:30:49 2020
##################################################
...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.DNC_relay_control_0 = DNC.relay_control(64, 120, 121, 122, 50)
        self.DNC_check_received_packet_0_0 = DNC.check_received_packet(64, 121)
        self.DNC_check_received_packet_0 = DNC.check_received_packet(64, 120)

        ##################################################
        # Connections
        ##################################################
        self.connect((self.DNC_check_received_packet_0, 0), (self.DNC_relay_control_0, 0))
        self.connect((self.DNC_check_received_packet_0_0, 0), (self.DNC_relay_control_0, 1))
        self.connect((self.DNC_relay_control_0, 0), (self.s4a_byte_to_bit_0, 0))
        ...
        self.connect((self.s4a_bpsk_demapper_0, 0), (self.DNC_check_received_packet_0, 0))
        self.connect((self.s4a_bpsk_demapper_0_0, 0), (self.DNC_check_received_packet_0_0, 0))
