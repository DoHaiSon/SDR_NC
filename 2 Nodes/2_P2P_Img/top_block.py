...
# Title: Top Block
# Generated: Sat Jan 23 11:21:22 2021
##################################################
...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.osmosdr_source_0_0.set_center_freq(2.45e9, 0)
        ...
        self.osmosdr_sink_0 = osmosdr.sink( args="numchan=" + str(1) + " " + 'bladerf=3144' )
        ...
        self.DNC_receiver_control_p2p_0 = DNC.receiver_control_p2p(data_size, 187, 170)
        ...
        self.connect((self.DNC_receiver_control_p2p_0, 1), (self.DNC2_zero_elimination_0, 0))
        self.connect((self.DNC_receiver_control_p2p_0, 0), (self.s4a_byte_to_bit_0, 0))
        ...
        self.connect((self.s4a_bpsk_demapper_0, 0), (self.DNC_receiver_control_p2p_0, 0))
